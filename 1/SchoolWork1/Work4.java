...
public class Work4 {
    public static void main(String[] args) {
        ...
        if (xDistance <= (w1 - w2) / 2 && yDistance <= (h1 - h2) / 2) System.out.println("r2 is inside r1");
        else if (xDistance <= (w1 + w2) / 2 && yDistance <= (h1 + h2) / 2) System.out.println("r2 overlaps r1");
